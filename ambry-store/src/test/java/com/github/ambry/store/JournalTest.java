...
public class JournalTest {
  ...
  public void testJournalOperation() {
    ...
    addEntryAndVerify(journal, new Offset(firstLogSegmentName, 0), new MockId("id1"), EnumSet.of(IndexEntryType.PUT),
        journalEntries);
    ...
    addEntryAndVerify(journal, new Offset(firstLogSegmentName, 1000), new MockId("id2"), EnumSet.of(IndexEntryType.PUT),
        journalEntries);
    addEntryAndVerify(journal, new Offset(firstLogSegmentName, 2000), new MockId("id3"), EnumSet.of(IndexEntryType.PUT),
        journalEntries);
    addEntryAndVerify(journal, new Offset(firstLogSegmentName, 3000), new MockId("id4"), EnumSet.of(IndexEntryType.PUT),
        journalEntries);
    addEntryAndVerify(journal, new Offset(firstLogSegmentName, 4000), new MockId("id5"), EnumSet.of(IndexEntryType.PUT),
        journalEntries);
    addEntryAndVerify(journal, new Offset(secondLogSegmentName, 0), new MockId("id6"), EnumSet.of(IndexEntryType.PUT),
        journalEntries);
    addEntryAndVerify(journal, new Offset(secondLogSegmentName, 1000), new MockId("id7"),
        EnumSet.of(IndexEntryType.PUT), journalEntries);
    ...
    addEntryAndVerify(journal, new Offset(secondLogSegmentName, 3000), new MockId("id9"),
        EnumSet.of(IndexEntryType.DELETE, IndexEntryType.TTL_UPDATE), journalEntries);
    ...
    Assert.assertEquals(entries.get(0).getIndexEntryTypes(), EnumSet.of(IndexEntryType.PUT));
    ...
    Assert.assertEquals(entries.get(0).getIndexEntryTypes(),
        EnumSet.of(IndexEntryType.DELETE, IndexEntryType.TTL_UPDATE));
  ...
  public void testJournalBootstrapMode() {
    ...
    addEntryAndVerify(journal, offsets[0], keys[0], EnumSet.of(IndexEntryType.PUT), journalEntries);
    addEntryAndVerify(journal, offsets[1], keys[1], EnumSet.of(IndexEntryType.PUT), journalEntries);
    ...
    addEntryAndVerify(journal, offsets[2], keys[2], EnumSet.of(IndexEntryType.PUT), journalEntries);
    ...
    addEntryAndVerify(journal, offsets[3], keys[3], EnumSet.of(IndexEntryType.PUT), journalEntries);
    Assert.assertEquals("Unexpected journal size", 2, journal.getCurrentNumberOfEntries());
