 ...
 * it and then use a {@link NioNetworkClient} directly to send requests to and get responses from the {@link MockServer}.
 * Since the {@link NioNetworkClient} used by the router and the test are different, and since the
